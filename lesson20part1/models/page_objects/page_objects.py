...
from lesson20part1.models.locator import AdminPageLocators, DashboardLocators
from lesson20part1.models.locator import MainPageLocators, ProductPageLocators
from lesson20part1.models.page import BasePage
...
class DashboardPage(BasePage):
    ...
    def get_product(self, product_name, delay):
        try:
            ...
            products = self.get_product_list(delay)
